...
class LinearAlgebra:
    ...
    #determinant (supports 2x2 and 3x3)
    ...
    #GAUSSIAN ELIMINATION TO SOLVE SLE
...
def char_poly_coefficients(A):
    #characteristic polynomial coeffs for 2x2 and 3x3 matrices
    n = len(A)
    if n == 2:
        a = 1
        b = - (A[0][0] + A[1][1])
...
def eigenvalues_eigenvectors(A):
    ...
    return lambdas, eigenvectors  #result
